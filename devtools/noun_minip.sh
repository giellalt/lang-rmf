...
do
 ...
 do
      echo "${lemma}${form}" | $HLOOKUP $GTLANGS/lang-rmf/src/fst/generator-gt-norm.hfstol # hfst
#      echo "${lemma}${form}" | $LOOKUP $GTLANGS/lang-rmf/src/fst/generator-gt-norm.xfst # xfst
 done
 rm -f $L_FILE
done
